                ...
                <div style={styles.body}>
                    <div style={styles.profileContainer}>
                        ...
                        <div style={styles.profileDetails}>
                            <p>
                                <strong style={{ marginRight: "75px" }}>Name</strong> {profileData.name}
                            </p>
                            <p>
                                <strong style={{ marginRight: "100px" }}>Id</strong> {profileData.id}
                            </p>
                            <p>
                                <strong style={{ marginRight: "34px" }}>Department</strong> {profileData.department}
                            </p>
                            <p>
                                <strong style={{ marginRight: "73px" }}>Email</strong> {profileData.email}
                            </p>
                            <p>
                                <strong style={{ marginRight: "48px" }}>Phone No</strong> {profileData.phno}
                            </p>
                        </div>
                    </div>
                </div>
